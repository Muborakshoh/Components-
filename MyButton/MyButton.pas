  ...
  case FButtonShape of
    ...
    begin
      ...
      begin
        ...
        Points[1] := R.BottomRight;
        Points[2] := Point(R.Left + ((R.Left + R.Right) div 2), R.Top);
      ...
      Points[0] := Point(R.Left,R.Bottom);
      Points[1] := R.BottomRight;
      Points[2] := Point(R.Right,R.Top + ((R.Bottom - R.Top) div 2));
      Points[3] := Point(R.Left + ((R.Left + R.Right) div 2), R.Top);
      Points[4] := Point(R.Left,R.Bottom - ((R.Bottom - R.Top) div 2));
      Points[5] := Point(R.Left,R.Bottom);
      ...
      bsSix:
          begin
            SetLength(Points, 7);
            Points[0] := Point(R.Left + ((R.Right - R.Left) div 3), R.Top);
            Points[1] := Point(R.Left, R.Top + ((R.Bottom - R.Top) div 2));
            Points[2] := Point(R.Left + ((R.Right - R.Left) div 3), R.Bottom);
            Points[3] := Point(R.Right - ((R.Right - R.Left) div 3), R.Bottom);
            Points[4] := Point(R.Right, R.Top + ((R.Bottom - R.Top) div 2));
            Points[5] := Point(R.Right - ((R.Right - R.Left) div 3), R.Top);
            Points[6] := Point(R.Left + ((R.Right - R.Left) div 3), R.Top);
